...
let BugReporter = ({
  ...
  return (
    <div className="bug-report">
      <button
        type="button"
        title="Сообщить об ошибке в вопросе"
      ...
      {show && (
        <div className="reporter">
          ...
          <p>
            Если в вопросе что-то не так — опечатка, неверный ответ,
            непонятная формулировка — опишите проблему:
          </p>
          <form onSubmit={onSubmit}>
            <textarea name="feedback" aria-label="Описание проблемы" />
            <input type="submit" value="Отправить" aria-label="Отправить сообщение об ошибке" />
          </form>
        </div>
      )}
    </div>
          ...
          <>
            <p>
              ...
              <label htmlFor={explanationId}>
                В одном-двух предложениях объясните, почему вы выбрали такой ответ.
                &nbsp;&nbsp;
  ...
  return (
    <div className={classNames("answer", questionClass)}>
      ...
      <div className="answer-row">
        <div>
          <div className="answer-header">Вы ответили:</div>
          <div>
            <methods.AnswerView
              answer={userAnswer}
        ...
        {showCorrect && !correct && (
          <div>
            <div className="answer-header">Правильный ответ:</div>
            <div>
              <methods.AnswerView
                answer={question.answer}
                baseline={question.answer}
      ...
      {showCorrect && question.context && (
        <div className="context">
          <MarkdownView markdown={`**Пояснение**:\n${question.context}`} />
        </div>
      )}
    </div>
  );
